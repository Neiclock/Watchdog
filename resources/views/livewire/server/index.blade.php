...
$notificationTest = function () {
    Notification::new()->title('Hello from NativePHP')->message('This is a detail message coming from your Laravel app.')->show();
};
...
<div>
    <div class="flex items-center justify-between mb-10">
        ...
        <a href="{{ url('/home') }}" type="button"
            class="bg-pink-600 px-2 py-1 text-xs font-bold text-white shadow hover:bg-pink-500">Site Benchmark</a>
    </div>
    <div wire:poll>
