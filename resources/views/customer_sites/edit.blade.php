                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">{!! FormField::radios(
                                'priority_code',
                                ['high' => 'High', 'normal' => 'Normal', 'low' => 'Low'],
                                ['label' => __('customer_site.priority_code')],
                            ) !!}</div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                {!! FormField::text('notify_user_interval', [
                                    ...
                                    'addon' => [
                                        'before' => __('time.every'),
                                        'after' => trans_choice('time.minutes', $customerSite->notify_user_interval),
                                    ],
                                    'type' => 'number',
                                    'min' => 0,
                                    'max' => 60,
